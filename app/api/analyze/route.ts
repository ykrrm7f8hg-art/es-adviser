...
const responseSchema = {
  ...
  properties: {
    questionType: {
      type: "string",
      enum: ["ガクチカ系", "自己PR系", "志望動機系", "サービス分析系", "改善提案系", "理由説明系", "学び系", "価値観系", "将来像系", "一般質問"]
    },
            ...
            content: [
              {
                ...
                text: JSON.stringify({
                  task: "ES診断",
                  rules: [
                    "最初に設問タイプを判定する。タイプは、ガクチカ系、自己PR系、志望動機系、サービス分析系、改善提案系、理由説明系、学び系、価値観系、将来像系、一般質問のいずれかにする",
                    "設問タイプごとの評価項目で回答漏れを判定する。タイプ間で評価項目を混ぜない",
                    "ガクチカ系は、経験、課題、行動、工夫、成果、学びを見る。新歓運営、サークル運営、アルバイト、研究、インターン、プロジェクト等は経験として扱う",
                    "ガクチカ系では、提案、実施、主導、企画、変更、改善、呼びかけは行動として扱う。交流機会を増やした、フィードバック方法を変えた等は行動と工夫の両方に該当しうる",
                    "ガクチカ系では、参加者が増加した、売上が伸びた、評価された、達成した等を成果として扱う",
                    "自己PR系は、強み、具体エピソード、行動、成果、再現性を見る",
                    "志望動機系は、興味分野、企業との接点、志望理由、期待すること、学びとの接続を見る。行動、成果、工夫は評価しない",
                    "サービス分析系は、サービス名、良いと思った理由、具体機能、ユーザー視点、自分の考察を見る。リーダーシップや成果は評価しない",
